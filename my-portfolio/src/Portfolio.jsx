// Legacy prototype file kept only to prevent accidental imports from breaking.
// The app uses `Portfolio.tsx`.
...
const tag = (label) => (
  ...
  >
    {label}
    <span style={{ flex: 1, maxWidth: 48, height: 1, background: P.border }} />
  </span>
);
...
return (
  ...
  >
    ...
    >
      <Aurora colors={["#a78bfa", "#f472b6", "#34d399", "#60a5fa"]} blur={90} />
    ...
    >
      ...
      >
        <ScrollReveal direction="left">
          ...
          <p style={{ color: P.muted, lineHeight: 1.85, marginBottom: 20 }}>
            My foundation is{" "}
            <strong style={{ color: P.text }}>HTML, CSS, and JavaScript</strong>
            , and I&apos;m actively expanding into modern tools like Bootstrap
            and SASS. I enjoy taking a project from a rough idea to something
            that actually works well and looks good.
          </p>
          <p style={{ color: P.muted, lineHeight: 1.85 }}>
            Outside of coursework, I build personal projects — web games, hobby
            pages — and take on client work to sharpen real-world skills. I
            believe the best way to learn is to build things that matter.
          </p>
        </ScrollReveal>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Studying front-end and full-stack web development. Coursework
                  covers HTML, CSS, JavaScript, responsive design, accessibility
                  standards, Bootstrap, SASS, and version control with Git.
                </p>
                <span
                  style={{
    ...
    >
      ...
      >
        A mix of client work, web games, and personal projects — all on GitHub.
      </p>
      <div style={{ marginTop: 48 }} role="list">
        {[
          {
...
// (prototype continues commented out)
