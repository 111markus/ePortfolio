      ...
      <div className="mx-auto max-w-6xl px-6 py-24">
        <FadeContent>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/70 sm:text-base">
            Mõned projektid, mille kallal olen töötanud. Klikka kaardile, et
            vaadata GitHub’i või live demo.
          </p>

          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {projects.map((p) => (
              <TiltCard key={p.id} className="group">
                <SpotLight className="group rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="shrink-0 rounded-2xl border border-white/10 bg-black/20 px-3 py-1 font-mono text-[10px] tracking-[0.2em] text-white/60">
